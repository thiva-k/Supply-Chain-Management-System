...
import NewOrdersStore from './components/store/newOrder';
import AddTruck from './components/store/addNewTruck';
  ...
  render() {
    ...
    const store = (<div>
      ...
      < Routes >
        ...
        <Route path='/store/addTruck' element={<AddTruck store_id={this.state.customer.store_id}  />} />
        <Route path='/store/ordersontrain' element={<OrdersOnTrain store_id={this.state.customer.store_id} />} />
        <Route path='/store/neworder' element={<NewOrdersStore store_id={this.state.customer.store_id} />} />
    ...
    const nullPart = (<div >
      ...
      {/* <div style={{backgroundImage: "url(${/supply-chain-management.jpg})" }}>
        thanikan
        <img src='supply-chain-management'/>
        dwf
        <p></p><p></p>
      </div> */}
    </div>)
