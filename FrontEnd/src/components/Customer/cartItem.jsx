    ...
    return (
      ...
      >
        <div className="col-2">
          {" "}
          <img
            src={require("../../Images/" + this.props.cart.img)}
            alt="adsakk"
            style={{ height: "140px", width: "100%", objectFit: "contain" }}
          />
        </div>
        <div
          className="col-2 h3 fw-bold"
        ...
        <div className="col-4">
          <button
            ...
            disabled={
              this.props.cart.count === this.props.cart.quantity ? "ture" : ""
            }
          >
            <i className="fa fa-plus"></i>
          </button>
          <button
            className="btn-sm btn-success btn ms-3"
            onClick={this.props.onDecrement}
            disabled={this.props.cart.count === 0 ? "ture" : ""}
          >
            {" "}
