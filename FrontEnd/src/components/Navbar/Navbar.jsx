        ...
        return (
            < nav className="navbar navbar-expand-lg navbar-bg" >
                ...
                < div className="container-fluid" >
                    <a className="navbar-brand navbar-font" href="/">Name of our Page</a>
                    ...
                    {(this.props.user.length !== 0) &&
                        <div className="d-flex" style={{ marginTop: '1px', marginBottom: '1px' }}>
                            <h5 className='align-middle mt-3 me-3 fw-bolder' style={{ color: '#4A148C', cursor: 'pointer' }} onClick={() =>{ this.logOut();super.setState({  customer: [], role: '' }); console.log(super.state); this.redirect("login")}}>Logout</h5>
                    ...
                    {(this.props.user.length === 0) &&
                        <div className="d-flex" style={{ marginTop: '1px', marginBottom: '1px' }}>
                            <h5 className='align-middle mt-3 me-3 fw-bolder' style={{ color: '#4A148C', cursor: 'pointer' }} onClick={() => this.redirect('login')}>Log In</h5>
                            <h5 className='align-middle mt-3 me-3 fw-bolder' style={{ color: '#4A148C', cursor: 'pointer' }} onClick={() => this.redirect('signup')}>Sign Up</h5>
                        </div>}
