...
CREATE TABLE `driver_roster` (
  ...
  CONSTRAINT `driver_roster_ibfk_1` FOREIGN KEY (`driver_id`) REFERENCES `driver` (`driver_id`),
  CONSTRAINT `driver_roster_ibfk_2` FOREIGN KEY (`route_id`) REFERENCES `route` (`route_id`)
