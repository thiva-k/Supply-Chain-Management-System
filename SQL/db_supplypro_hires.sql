...
CREATE TABLE `hires` (
  ...
  `workerType` varchar(40) DEFAULT NULL,
  PRIMARY KEY (`worker_id`,`store_id`),
  KEY `store_id` (`store_id`),
  CONSTRAINT `hires_ibfk_1` FOREIGN KEY (`store_id`) REFERENCES `store` (`store_id`),
  CONSTRAINT `hires_ibfk_2` FOREIGN KEY (`worker_id`) REFERENCES `driver` (`driver_id`),
  CONSTRAINT `hires_ibfk_3` FOREIGN KEY (`worker_id`) REFERENCES `assistant` (`assistant_id`)
